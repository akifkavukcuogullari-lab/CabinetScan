...
lane :beta do
  ...
  build_app(scheme: "NextLeanScan")
  upload_to_testflight
end

lane :release do
  build_app(scheme: "NextLeanScan", configuration: "Release")
  upload_to_app_store
end
```
